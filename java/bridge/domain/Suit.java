 ...
 */
public class Suit {
    public static final Suit SPADES = new Suit(0, 'S', "Spades");//黑桃
    public static final Suit HEARTS = new Suit(1, 'H', "Hearts");//红心
    public static final Suit DIAMONDS = new Suit(2, 'D', "Diamonds");//方块
    public static final Suit CLUBS = new Suit(3, 'C', "Clubs");//梅花
